...
namespace Redyser\MagentoCarrier\Model\Config\Backend;

class GUID extends \Magento\Framework\App\Config\Value
{
    const CUSTOM_OPTION_STRING_PATH = 'redyser_magentocarrier_test/test_backend/another_option';
    ...
    public function beforeSave()
    {
        ...
        $this->setValue($this->getValue());//intval($this->getValue()));
